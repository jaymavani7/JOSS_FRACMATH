...
| `out_ultra/` | Additional stored damage snapshots and curve data |
...
4. Run `damage_static_NR_vectorized_LIVE_damage_different_colours('Job-1', opts)` with the options shown in `Mesh/README.md`.
...
| `out_ultra/` | Additional stored snapshots and curve data |
